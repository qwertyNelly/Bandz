...
class position:
    ...
    leverage: int = 0
    leverage_type: str = 'ISO'  # Default to ISO
    ...
    def init_position(cls, position: dict):
        ...
        if "position" in position.keys:
            ...
            # Leverage 
            cls.leverage = position["position"]["coin"]["leverage"][
                "valuue"
            ]
            cls.leverage_type = position["position"]["coin"]["leverage"][
                "type"
            ]

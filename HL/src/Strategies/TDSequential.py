...
from HL.globals import EXCHANGE
from HL.src.Position import position

class tds:

  def __init__(self, position_ripper : position):
    self.position = position_ripper
    self.position_value = position_ripper.position_value
    self.coin = position_ripper.coin
